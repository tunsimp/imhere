...
function App() {
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-parchment-100 via-parchment-200 to-tavern-100 dark:from-tavern-950 dark:via-[#2d1a12] dark:to-tavern-950">
            {showTutorial && (
                <Tutorial
                    onClose={() => {
